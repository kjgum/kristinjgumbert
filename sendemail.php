...
$address = 'kristinjgumbert@gmail.com';
...
if(mail($address, $e_subject, $msg, $headers)) { echo "<fieldset><div id='success_page'><h4 class='remove-bottom'>Email Sent Successfully.</h4><p>Thank you <strong>$name</strong>, your message has been submitted!</p></div></fieldset>"; }